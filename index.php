...
if (!isset($_SESSION['user_id']) || (time() - $_SESSION['LAST_ACTIVITY'] > 1800)) {
    // Użytkownik nie jest zalogowany lub czas sesji minął
    header("Location: /bramki/login.php");    exit;
}
$_SESSION['LAST_ACTIVITY'] = time(); // aktualizacja ostatniej aktywności
?>
<!DOCTYPE html>
<html lang="pl">
<head>
    ...
    <div class="user-info">
        ...
        <p>Nick: <?php echo $_SESSION['nickname']; ?></p>
    </div>
</nav>
